...
var start = function () { return __awaiter(_this, void 0, void 0, function () {
    var db, port, options, graphQLServer;
    return __generator(this, function (_a) {
        // Create a mongodb client
        mongoose.connect(process.env.MONGODB_URI);
        db = mongoose.connection;
        db.on('error', console.error.bind(console, 'connection error:'));
        db.once('open', function (_) { return console.log('MongoDB now connected'); });
        port = 4000;
        options = {
            tracing: true,
            cacheControl: true,
        ...
        graphQLServer = new graphql_yoga_1.GraphQLServer({
        ...
        graphQLServer.start(options, function (_) {
