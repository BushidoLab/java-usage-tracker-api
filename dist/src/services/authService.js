            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        user = _b.sent();
                        return [2 /*return*/, {
                                token: jsonwebtoken_1.sign({ userId: user._id }, process.env.TOKEN_SECRET),
                                user: user,
                            }];
                    case 3:
                        error_1 = _b.sent();
                        throw errorHandler_1.errorHandler('CreateUserError', {
                            ...
                            data: error_1.response.data.error
                        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        error_2 = _b.sent();
                        throw errorHandler_1.errorHandler('UserLoginError', {
                            message: 'There was an error logging in',
                            data: error_2.response.data.error,
                        });
                    case 4: return [2 /*return*/];
                }
            });
